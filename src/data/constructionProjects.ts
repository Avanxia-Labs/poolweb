...
export const constructionProjects: ConstructionProject[] = [
  ...
  // RESIDENTIAL RENOVATION
  {
    ...
    description: 'Full residential pool refurbishment by our in-house crew: removed aged plaster, installed new waterline tile and pavers coping, and applied a fresh white quartz finish for a clean, modern look.',
    images: [
