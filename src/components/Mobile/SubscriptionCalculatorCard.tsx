  ...
  return (
    <div
      ...
      <div className="relative z-20">
        {/* Contenido principal */}
        <div className="relative z-20">
          <div className="flex flex-col gap-5 w-[248px] ml-0">
            <h2 className="text-lg font-bold text-left text-slate-900">
       ...
       {/* Campo de entrada */}
        <div className="mb-4 w-[248px] mx-auto text-left">
        ...
        {/* Botón de acción */}
        <button
          className="mt-6 flex flex-col justify-center items-center gap-[4.236px] px-[8.472px] py-[6.778px] text-[12px] font-extrabold text-white bg-[#485AFF] rounded-[3.389px] w-fit"
        >
