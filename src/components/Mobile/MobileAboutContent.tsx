        ...
        <div className="flex flex-col gap-6">
          {cardData.map((card, i) => (
            ...
            >
              ...
              <div
                className={`absolute w-[200px] h-[200px] left-[-100px] top-[-100px] rounded-full blur-[20px] transition-all duration-700 ease-out z-0 ${visibleCards[i] ? "opacity-100 scale-100" : "opacity-0 scale-50"
                  }`}
                style={gradientStyle}
              />
              ...
              <div
                className={`absolute w-[200px] h-[200px] right-[-80px] bottom-[-80px] rounded-full blur-[20px] transition-all duration-700 ease-out z-0 ${visibleCards[i] ? "opacity-100 scale-100" : "opacity-0 scale-50"
                  }`}
                style={gradientStyle}
              />
