...
function Section6() {
  ...
  // Add scroll listener for more precise control on mobile
  useEffect(() => {
    if (!isMobile) return; // Only apply this effect on mobile
  ...
  const shouldStraighten = isMobile ? sectionTopInView : isHovering;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className='flex w-full md:w-1/3 flex-col justify-center gap-4 md:gap-6 lg:gap-[2.5rem] z-10 py-4 md:py-0'
      >
        <h2 className="text-[#F5F9FF] font-['Plus_Jakarta_Sans'] text-4xl lg:text-5xl font-bold leading-tight mb-4 transition-all duration-700">
          Customers say About Us
        </h2>
        <p className="text-[#F5F9FF]/90 font-inter text-base lg:text-lg font-normal leading-relaxed transition-all duration-700 delay-300">
          Trust is built through results. Here you can read what our clients say about their experience with our service. Their words reflect our commitment to quality and excellence.
        </p>
      </div>
      ...
      {/* Comments container */}
      <div
        className='relative w-full md:w-2/3 h-[350px] md:h-full px-2 md:px-4 lg:px-[1.5rem] py-4 md:py-[1.5rem] flex flex-col md:flex-row items-center justify-center'
      ...
      >
        ...
        <div className='hidden lg:block w-full h-full relative'>
          ...
          <div
            id='Comentario1'
            className={`rounded-2xl absolute z-5 flex bg-black md:h-[300px] lg:h-[348px] md:w-[340px] lg:w-[400px] flex-col items-start gap-[10px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] transition-all duration-1000 ${shouldStraighten ? 'rotate-[0deg]' : 'rotate-[-15deg]'}`}
            style={{
              left: '3%',
              top: '5%',
              opacity: 1
          ...
          <div
            id='Comentario2'
            className={`rounded-2xl absolute z-10 flex bg-black md:h-[280px] lg:h-[318.575px] md:w-[330px] lg:w-[396.277px] flex-col items-start gap-[10px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] transition-all duration-1000 delay-300 ${shouldStraighten ? 'rotate-[0deg]' : 'rotate-[15deg]'}`}
            style={{
              left: '50%',
              top: '48%',
              opacity: 1
