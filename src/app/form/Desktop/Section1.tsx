  ...
  return (
    <section className="bg-[#F4F4F5] relative w-full min-h-screen overflow-hidden">
      <div className="container mx-auto px-4 max-w-[1920px]">
        <div className="relative flex flex-col lg:flex-row items-center justify-between py-12 md:py-16 lg:py-20">
          {/* Left side with text */}
          <div className="relative justify-center  xl:justify-between flex flex-row lg:flex-col lg:justify-between lg:h-[1200px]  w-full lg:w-[50%] mb-12 lg:mb-0 py-2 lg:pt-0">

            <div className=" flex flex-col items-center justify-center lg:max-w-[29rem] text-center lg:text-left z-20">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4">
                Let's<br />work<br />together!
              </h1>
              <p className="text-lg text-gray-600 max-w-md">
          ...
          {/* Foto por debajo de lg */}
          <div className="h-[1190px] w-full  mb-[20px] block lg:hidden">
            <img
              //src='/images/yosbanismall.png'
              src='test.png'
              alt="Yosbani"
      ...
      {/* Vector background a partir de lg */}
      {/* <div className="absolute lg:bottom-0 left-0 w-full z-[5]">
        <img
          src='/svgs/YosbaniVector_H1000.svg'
          alt="Vector background"
          className="w-full object-cover"
