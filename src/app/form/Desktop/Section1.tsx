      ...
      <div className="container mx-auto px-4 max-w-[1920px]">
        <div className="relative flex flex-col lg:flex-row items-center justify-between py-12 md:py-16 lg:py-20">
          ...
          <div className=" flex flex-row w-full lg:w-[50%] mb-12 lg:mb-0 pt-10 lg:pt-0">
            ...
            <div className="mt-8 text-center lg:text-left z-20">
          ...
          {/* Vector background por debajo de lg */}
          <div className="absolute h-screen block top-[-20px] lg:hidden lg:bottom-0 left-0 w-full z-[10]">
            {/* <img
              // src={vectorSrc} 
