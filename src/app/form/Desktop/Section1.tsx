    ...
    <section className="bg-[#F4F4F5] relative w-full min-h-screen overflow-hidden">
      <div className="w-full">
        <div className="min-h-screen relative flex flex-col lg:flex-row">
          {/* Left side with image - positioned absolutely to ensure it touches borders */}
          <div className="relative lg:w-5/9 2xl:w-1/2 min-h-screen">
            ...
            {/* Desktop image container with absolute positioning */}
            <div className="hidden lg:block absolute inset-0">
              {/* Force the image to fill the entire container and touch all edges */}
              <div className="relative h-full w-full">
                <img
                  src='/images/yosbaniContact.png'
                  alt="Yosbani"
                  className="absolute bottom-0 left-0 w-full h-full object-cover object-left-bottom"
          ...
          <div className="flex flex-col 2xl:justify-center w-full lg:w-4/9 2xl:w-1/2 lg:pl-10 xl:pl-20 px-4 lg:px-0 lg:pr-10">
            {/* Contact cards */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 mt-6 lg:mt-16">
              <div className="xl:h-[100px] 2xl:h-[120px] hover:rounded-[7px] hover:bg-white hover:shadow-[0px_9px_7.9px_rgba(0,0,0,0.4)] transition-all duration-300 bg-white p-4 rounded shadow-sm flex flex-col items-center justify-center">
